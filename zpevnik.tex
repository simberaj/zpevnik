...
\copyright~Jan Šimbera - Prófa, simbera.jan@gmail.com
\normalfont
\end{center}
\vspace{\stretch{2}}
\rmfamily
...
\beginsong{Atlantida}[by={Miro Žbirka}]\label{song-16}
\capo{2}
\num
...
\beginsong{Až}[by={Tomáš Klus}]\label{song-17}
\transpose{7}
\num
...
\beginsong{Až se k nám právo vrátí}[by={Spirituál kvintet}]\label{song-18}
\num
...
\beginsong{Babylon}[by={Jaromír Nohavica}]\label{song-19}
\num
...
\beginsong{Bagdád}[by={Divokej Bill}]\label{song-20}
\num
...
\beginsong{Balada}[by={Tomáš Klus}]\label{song-21}
\emptyv
\cseq{\[Em] \[C] \[G] \[D]}\\
\cl
\chordsoff
...
\beginsong{Barbarské pobřeží}[by={Asonance}]\label{song-22}
...
\beginsong{Barbie Army}[by={Dominik Zezula}]\label{song-23}
\freev
...
\beginsong{Batalion}[by={Spirituál kvintet}]\label{song-24}
\bridge
...
\beginsong{Battledress}[by={Greenhorns}]\label{song-25}
\num
...
\beginsong{Běda poraženým (Vae victis)}[by={Klíč}]\label{song-26}
\num
...
\beginsong{Berousek}[by={Mňága a Žďorp}]\label{song-27}
\intro
\cseq{\[C] \[F] \[Dm] \[C] \[G]}\\
\cl
\chordsoff
...
\beginsong{Bedna od whisky}[by={Hoboes}]\label{song-28}
\num
...
\beginsong{Behind Blue Eyes}[by={Limp Bizkit}]\label{song-29}
\capo{3}
...
\beginsong{Bezpečné reggae}[by={Žamboši}]\label{song-30}
\num
...
\beginsong{Black Velvet Band}[by={The Dubliners}]\label{song-31}
\num
...
\beginsong{Bláznova ukolébavka}[by={Pavel Dydovič}]\label{song-32}
\num
...
\beginsong{Blowing in the wind}[by={Bob Dylan}]\label{song-33}
\num
...
\beginsong{Blues folsomské věznice}[by={Johnny Cash / Jan Vyčítal}]\label{song-34}
\num
...
\beginsong{Blues o spolykaných slovech}[by={Michal Prokop}]\label{song-35}
%\transpose{-2}
...
\beginsong{Body in a Box}[by={City and Colour}]\label{song-36}
\capo{2}
...
\beginsong{Boli sme raz milovaní}[by={Pavol Habera}]\label{song-37}
\num
...
\beginsong{Bon soir Mademoiselle Paris}[by={Olympic}]\label{song-38}
\num
...
\beginsong{Boty proti lásce}[by={Yvonne Přenosilová}]\label{song-39}
\num
...
\beginsong{Boulevard Of Broken Dreams}[by={Green Day}]\label{song-40}
\num
...
\beginsong{Bratříčku, zavírej vrátka}[by={Karel Kryl}]\label{song-41}
\num
...
\beginsong{Bright Side of Life}[by={Monty Python}]\label{song-42}
\num
...
\beginsong{Bruce Willis}[by={Kabát}]\label{song-43}
\num
...
\beginsong{Buď můj salám}[by={Hm}]\label{song-44}
...
\beginsong{Buď na mě hodná}[by={Wanastowi Vjecy}]\label{song-45}
\num
...
\beginsong{Can You Feel The Love Tonight}[by={Elton John}]\label{song-46}
\intro
...
\beginsong{Carpe diem}[by={AG Flek}]\label{song-47}
...
\beginsong{Cesta}[by={Kryštof feat. Tomáš Klus}]\label{song-48}
\emptyv
\cseq{\[C] \[G] \[Am] \[F] \[G]}\\
\cl
\chordsoff
...
\beginsong{Cestou do Jenkovic}[by={Radůza}]\label{song-49}
...
\beginsong{Cesty Páně}[by={Mňága a Žďorp}]\label{song-50}
\emptyv
\cseq{\[E] \[A] \[F\shrp{}m] \[H]}\\
\cl
\chordsoff
...
\beginsong{Cliché}[by={Support Lesbiens}]\label{song-51}
\capo{4}
...
\beginsong{Co jste, hasiči}\label{song-52}
\num
...
\beginsong{Co když}[by={Vlasta Redl}]\label{song-53}
\num
\chordson
...
\beginsong{Co nadělám}[by={Devítka}]\label{song-54}
\num
...
\beginsong{Co se to stalo, bratříčku}[by={Jaromír Nohavica}]\label{song-55}
\pick{PI(MA)I}
...
\beginsong{Colorado}[by={Kabát}]\label{song-56}
\num
...
\beginsong{Cukrářská bosanova}[by={Jaromír Nohavica}]\label{song-57}
...
\beginsong{Cyklistika}[by={Jaromír Nohavica}]\label{song-58}
\capo{3}
\num
...
\beginsong{Čarodějnice z Amesbury}[by={Asonance}]\label{song-59}
\num
...
\beginsong{Čas}[by={Tomáš Klus}]\label{song-60}
\emptyv
\cseq{\[Hm] \[G] \[D] \[A]}\\
\cl
\chordsoff
...
\beginsong{Černá díra}[by={Karel Plíhal}]\label{song-61}
\num
...
\beginsong{Černej pasažér}[by={Traband}]\label{song-62}
\num
...
\beginsong{Čert ví proč}[by={Zuzana Navarová}]\label{song-63}
\transpose{7}
\num
...
\beginsong{Čtyři bytelný kola}[by={Greenhorns}]\label{song-64}
\num
...
\beginsong{Dajána}[by={Paul Anka \& Zdeněk Borovec}]\label{song-65}
\num
...
\beginsong{Dál, dál, dál}[by={Mňága a Žďorp}]\label{song-66}
\capo{5}
\emptyv
...
\beginsong{Darmoděj}[by={Jaromír Nohavica}]\label{song-67}
\num
...
\beginsong{David a Goliáš}[by={Jaroslav Ježek, Jiří Voskovec a Jan Werich}]\label{song-68}
\averse
...
\beginsong{Dědečkovy hodiny}[by={Taxmeni}]\label{song-69}
\num
...
\beginsong{Dej mi víc své lásky}[by={Olympic}]\label{song-70}
\num
...
\beginsong{Dělání}[by={Svěrák a Uhlíř}]\label{song-71}
\emptyv
\cseq{\[G] \[C] \[G] \[C]}\\
\cl
\chordsoff
...
\beginsong{Demáček}[by={Buty}]\label{song-72}
\intro
\cseq{\[Am] \[F] \[C] \[Am] \[F] \[C]}\\
\cl
\chordsoff
...
\beginsong{Dětské šaty}[by={Petr Kalandra}]\label{song-73}
\intro
...
\beginsong{Dezolát}[by={Vypsaná Fixa}]\label{song-74}
\emptyv
\cseq{\[Em] \[C] \[D] \[A]}\\
\cl
\chordsoff
...
\beginsong{Divoké koně}[by={Jaromír Nohavica}]\label{song-75}
\num
...
\beginsong{Divokej horskej tymián}[by={Pavel Lohonka Žalman}]\label{song-76}
\capo{3}
\num
...
\beginsong{Dlouhej kouř}[by={Chinaski}]\label{song-77}
\emptyv
\cseq{\[D] \[C] \[G]}
\cl
\chordsoff
...
\beginsong{Do nebe}[by={Tomáš Klus}]\label{song-78}
\emptyv
\cseq{\[G] \[D] \[Em] \[C]}\\
\cl
\chordsoff
...
\beginsong{Do posledního dechu}[by={Nerez}]\label{song-79}
\num
...
\beginsong{Dobrák od kosti}[by={Chinaski}]\label{song-80}
\emptyv
\cseq{\[D] \[A] \[G]}
\cl
\num\chordsoff
...
\beginsong{Dokud se zpívá}[by={Jaromír Nohavica}]\label{song-81}
\num
...
\beginsong{Don Quijote}[by={Jarret}]\label{song-82}
\num
...
\beginsong{Don't Look Back in Anger}[by={Oasis}]\label{song-83}
\intro
\cseq{\[G] \[C] \[G] \[C]}\\
\cl
\chordsoff
...
\beginsong{Dopis}[by={Karel Plíhal}]\label{song-84}
\num
\chordson
...
\beginsong{Dopis}[by={Tomáš Klus}]\label{song-85}
\num
...
\beginsong{Doprdele prace}[by={Jaromír Nohavica}]\label{song-86}
\emptyv
\cseq{\[Dm] \[G] \[B] \[A] \[Dm] \[A]}\\
\cl
\chordsoff
...
\beginsong{Dračí song}[by={LJH Chemik}]\label{song-87}
\num
...
\beginsong{Drobná paralela}[by={Chinaski}]\label{song-88}
\num
\chordson
...
\beginsong{Duj duj duj}[by={Buty}]\label{song-89}
\freev
...
\beginsong{Dva}[by={Zrní}]\label{song-90}
\bridge
...
\beginsong{Dva havrani}[by={Asonance}]\label{song-91}
\num
\chordson
...
\beginsong{Dva roky prázdnin}[by={Karel Černoch}]\label{song-92}
\averse
\chordson
...
\beginsong{Dvakrát}[by={Vlasta Redl}]\label{song-93}
\num
...
\beginsong{Dvě ryby}[by={Chemik}]\label{song-94}
\chorusi
...
\beginsong{Ej padá padá rosenka}[by={Blue Effect}]\label{song-95}
\chordsoff
\intro\emptyspace\\\cl
\num
\chordson
...
\beginsong{El Condor Pasa}[by={Paul Simon \& Art Garfunkel}]\label{song-96}
\num
...
\beginsong{Elektrický valčík}[by={Svěrák a Uhlíř}]\label{song-97}
\num
...
\beginsong{Emo}[by={Vobezdud}]\label{song-98}
...
\beginsong{Ešče si já pohár vína zaplatím}[by={Moravská}]\label{song-99}
\num
...
\beginsong{Ešče som sa něoženil}[by={Lidová}]\label{song-100}
\num
...
\beginsong{Éterická}[by={UDG}]\label{song-101}
\emptyv
\cseq{\[Dm] \[B] \[Am]}\\
\cl
\chordsoff
...
\beginsong{Ezop a brabenec}[by={Jaroslav Ježek, Jiří Voskovec a Jan Werich}]\label{song-102}
\freev
...
\beginsong{Fajn džob}[by={Hop Trop}]\label{song-103}
\num
...
\beginsong{Falling Slowly}[by={Frames}]\label{song-104}
\capo{3}
\num
...
\beginsong{Feather on the Clyde}[by={Passenger}]\label{song-105}
\capo{8}
\pick{P(IM)}
...
\beginsong{Fénix}[by={Nezmaři}]\label{song-106}
\num
...
\beginsong{Fields of Athenry}[by={The Dubliners}]\label{song-107}
\num
...
\beginsong{Fireflies}[by={Owl City}]\label{song-108}
\capo{7}
\num
...
\beginsong{Fotbal}[by={Jaromír Nohavica}]\label{song-109}
\num
...
\beginsong{Fram}[by={Wabi Daněk}]\label{song-110}
\capo{3}
\num
...
\beginsong{Frankie Dlouhán}[by={Nedvědi}]\label{song-111}
\num
...
\beginsong{František}[by={Buty}]\label{song-112}
\intro
\cseq{\[G] \[C] \[G] \[C]}\\
\cl
\chordsoff
...
\beginsong{Gaudeamus igitur}[by={Jaromír Nohavica}]\label{song-113}
\num
...
\beginsong{Gorale}[by={Čechomor / Gentlemen Singers (lidová)}]\label{song-114}
\num
\chordson
...
\beginsong{Grónská písnička}[by={Jaromír Nohavica}]\label{song-115}
\num
...
\beginsong{Hallelujah}[by={Rufus Wainwright}]\label{song-116}
\num
\chordson
...
\beginsong{Harfa}[by={Asonance}]\label{song-117}
\num
...
\beginsong{Heidi}[by={Kamelot}]\label{song-118}
\num
...
\beginsong{Hej, člověče Boží}[by={Nezmaři}]\label{song-119}
\capo{3}
\num
\chordson
...
\beginsong{Hej, lidi}[by={Devítka}]\label{song-120}
\capo{3}
\num
...
\beginsong{Hercegovina}\label{song-121}
\num
...
\beginsong{Here Comes The Sun}[by={Beatles}]\label{song-122}
\num
...
\beginsong{Hey Jude}[by={Beatles}]\label{song-123}
\num
...
\beginsong{Hezká holka}[by={Mňága a Ždorp}]\label{song-124}
\musicnote{akordy}
\emptyv
...
\beginsong{Hlásná Třebáň}[by={Ivan Mládek}]\label{song-125}
\num
...
\beginsong{Hlídač krav}[by={Jaromír Nohavica}]\label{song-126}
\emptyv
\cseq{\[C] \[F] \[G]}\\
\cl
\chordsoff
...
\beginsong{Hloupý a ztracený}[by={Mňága a Žďorp}]\label{song-127}
\num
...
\beginsong{Hlupáku, najdu tě}[by={Svěrák \& Uhlíř}]\label{song-128}
\num
...
\beginsong{Hodinový hotel}[by={Mňága a Žďorp}]\label{song-129}
\emptyv
\cseq{\[C] \[Em] \[A] \[F] \[G]}
\cl\chordsoff\num
...
\beginsong{Holes}[by={Passenger}]\label{song-130}
\capo{9}
\num
...
\beginsong{Holubí dům}[by={Jiří Schelinger}]\label{song-131}
\num
...
\beginsong{Homo}[by={Tomáš Klus}]\label{song-132}
\emptyv
\cseq{\[A] \[C\shrp{}m] \[D] \[E]}\\
\cl
\chordsoff
...
\beginsong{Honolulu}[by={Kamelot}]\label{song-133}
\num
...
\beginsong{House of the Rising Sun}[by={Americká folková balada}]\label{song-134}
\capo{2}
\num
...
\beginsong{Hrobař}[by={Premiěr}]\label{song-135}
\num
...
\beginsong{Hruška}[by={Čechomor}]\label{song-136}
\num
...
\beginsong{Hudsonské šífy}[by={Wabi Daněk}]\label{song-137}
\num
...
\beginsong{Hurt}[by={Johnny Cash}]\label{song-138}
\num
...
\beginsong{Husličky}[by={Vlasta Redl}]\label{song-139}
\num
...
\beginsong{Hvězda na vrbě}[by={Olympic}]\label{song-140}
\num
...
\beginsong{Hvězdář}[by={UDG}]\label{song-141}
\emptyv
\cseq{\[G] \[D] \[Am] \[C]}
\cl\chordsoff\num
...
\beginsong{Hvězdný Ursus}[by={Skokan a Koumák}]\label{song-142}
\num
...
\beginsong{Hvězdy nad hlavou}[by={Chinaski}]\label{song-143}
\num
...
\beginsong{Chacha}[by={Jaromír Nohavica}]\label{song-144}
\capo{3}
\chor
...
\beginsong{Chci zas v tobě spát}[by={Lucie}]\label{song-145}
\transpose{7}
\intro
...
\beginsong{Chtít chytit vítr}[by={Mňága a Ždorp}]\label{song-146}
\capo{3}
\freev
...
\beginsong{Chůze}[by={Bratři Ebenové}]\label{song-147}
\num
...
\beginsong{Chvíle}[by={Hop trop}]\label{song-148}
\num
...
\beginsong{I cesta může být cíl}[by={Mňága a Žďorp}]\label{song-149}
\emptyv
\cseq{\[F] \[C] \[B]}
\cl\chordsoff\num
...
\beginsong{I Like Birds}[by={Eels}]\label{song-150}
\capo{2}
\emptyv
\cseq{\[D] \[C] \[G]}\\
\cl
...
\beginsong{Igelit}[by={Nedvědi}]\label{song-151}
\num
\chordson
...
\beginsong{Imagine}[by={John Lennon}]\label{song-152}
\intro
...
\beginsong{Injekce morfia}[by={KSV}]\label{song-153}
\emptyv
\cseq{\[C] \[F]}\\
\cl
\chordsoff
...
\beginsong{Inzerát}[by={Tomáš Klus}]\label{song-154}
\emptyv
\cseq{\[G] \[D] \[Em] \[C]}\\
\cl
\chordsoff
...
\beginsong{Já na tom dělám}[by={Bratři Ebenové}]\label{song-155}
\num
...
\beginsong{Já neumím}[by={Jaromír Nohavica}]\label{song-156}
%\transpose{-2}
\num
...
\beginsong{Já písnička}[by={Pavlína Jíšová}]\label{song-157}
\num
...
\beginsong{Já s tebou žít nebudu}[by={Nerez}]\label{song-158}
...
\beginsong{Jablkový sad}[by={Mňága a Žďorp}]\label{song-159}
\emptyv
\cseq{\[E] \[H] \[A] \[H]}\\
\cl
\chordsoff
...
\beginsong{Jabloně}[by={Zrní}]\label{song-160}
\num
...
\beginsong{Japonečka}\label{song-161}
\num
...
\beginsong{Jarní tání}[by={Brontosauři}]\label{song-162}
\num
...
\beginsong{Jaro}[by={Fešáci}]\label{song-163}
\num
...
\beginsong{Jarošovský pivovar}[by={Argema}]\label{song-164}
\num
...
\beginsong{Jasná zpráva}[by={Olympic}]\label{song-165}
\intro
...
\beginsong{Javor}[by={Nerez}]\label{song-166}
\intro
...
\beginsong{Jdem zpátky do lesů}[by={Pavel Lohonka Žalman}]\label{song-167}
\num
...
\beginsong{Jdou po mně, jdou}[by={Jaromír Nohavica}]\label{song-168}
\num
...
\beginsong{Jean Reno}[by={Vobezdud}]\label{song-169}
\emptyv
\cseq{\[Am] \[F] \[Dm] \[G]}
\cl\chordsoff\num
...
\beginsong{Jednou budem dál}[by={Spirituál kvintet}]\label{song-170}
\num
...
\beginsong{Jesse James}\label{song-171}
\num
...
\beginsong{Jestli to nebude láska}[by={Zdeněk Svěrák a Jaromír Uhlíř}]\label{song-172}
\num
...
\beginsong{Ještě jedno kafe}[by={Druhá tráva}]\label{song-173}
\num
\chordson
...
\beginsong{Ještě mi scházíš}[by={Jaromír Nohavica}]\label{song-174}
...
\beginsong{Jízda králů}[by={Ulrychovi}]\label{song-175}
\averse
...
\beginsong{Jižní kříž}[by={Nedvědi}]\label{song-176}
\capo{2}
\num
...
\beginsong{Jolly Roving Tar}[by={The Irish Rovers}]\label{song-177}
\intro
...
\beginsong{Jožin z bažin}[by={Ivan Mládek}]\label{song-178}
\num
...
\beginsong{Kapr}[by={Jaromír Nohavica}]\label{song-179}
\num
...
\beginsong{Karavana mraků}[by={Karel Kryl}]\label{song-180}
\num
...
\beginsong{Kde jsou}[by={Karel Plíhal}]\label{song-181}
\capo{5}
\chorusi
...
\beginsong{Kde trubka zní}[by={Petr Nejedlý}]\label{song-182}
\num
...
\beginsong{Kdo vám tak zcuchal tmavé vlasy}[by={Hm}]\label{song-183}
\emptyv
\cseq{\[D] \[F] \[B] \[C]}\\
\cl
\chordsoff
...
\beginsong{Kdyby}[by={Jaromír Nohavica}]\label{song-184}
\num
...
\beginsong{Kdyby se v komnatách}[by={Zdeněk Svěrák a Jaromír Uhlíř}]\label{song-185}
\num
...
\beginsong{Kdyby tady byla taková panenka}[by={Lidová / Jaroslav Lohonka Žalman}]\label{song-186}
\num
...
\beginsong{Když je v Praze hic}[by={Ivan Mládek}]\label{song-187}
\num
...
\beginsong{Když mě brali za vojáka}[by={Jaromír Nohavica}]\label{song-188}
\num
...
\beginsong{Když náš táta hrál}[by={Greenhorns}]\label{song-189}
\num
...
\beginsong{Kláda}[by={Hop trop}]\label{song-190}
\num
...
\beginsong{Klára}[by={Chinaski}]\label{song-191}
\bridge
...
\beginsong{Klobouk ve křoví}[by={Voskovec a Werich}]\label{song-192}
\num
...
\beginsong{Kluziště}[by={Karel Plíhal}]\label{song-193}
\pick{PIMA}
\num
\chordson
...
\beginsong{Knockin' on Heaven's Door}[by={Bob Dylan}]\label{song-194}
\emptyv
\cseq{\[G] \[D] \[Am] \[G] \[D] \[C]}
\cl\chordsoff\num
...
\beginsong{Kočka na okně}[by={Jiří Suchý}]\label{song-195}
\chor
...
\beginsong{Kočky}[by={Nerez}]\label{song-196}
\capo{2}
...
\beginsong{Kolej Yesterday}[by={Framus 5}]\label{song-197}
\num
...
\beginsong{Kometa}[by={Jaromír Nohavica}]\label{song-198}
\num
...
\beginsong{Kozel}[by={Jaromír Nohavica}]\label{song-199}
\num
...
\beginsong{Krajina posedlá tmou}[by={Jiří Suchý a Jiří Šlitr}]\label{song-200}
\num
...
\beginsong{Královna z Dundrum Bay}[by={Nedvědi}]\label{song-201}
\num
...
\beginsong{Krambambule}[by={Evropská studentská píseň, česky Aiva s Koblihou}]\label{song-202}
\chordsoff\num
...
\beginsong{Kristián}[by={o5 and Radeček}]\label{song-203}
\num
...
\beginsong{Kristínka}[by={Peter Nagy}]\label{song-204}
\num
...
\beginsong{Kristy Are You Doing Okay}[by={The Offspring}]\label{song-205}
\intro
\cseq{\[C] \[F] \[G]}\\
\cl
\chordsoff
...
\beginsong{Krtek}[by={Buty}]\label{song-206}
\averse
...
\beginsong{Kryštof}[by={Kryštof}]\label{song-207}
\num
...
\beginsong{Kryštof}[by={Minikapela UMSKUP}]\label{song-208}
\capo{5}
\intro
\cseq{\[C] \[G] \[Am] \[F]}\\
\cl
...
\beginsong{Kurtizána}[by={UDG}]\label{song-209}
\averse
...
\beginsong{Kutil}[by={Chinaski}]\label{song-210}
\emptyv
\cseq{\[E] \[F\shrp{}m] \[A] \[E]}
\cl\chordsoff\num
Jsem kutil
...
\beginsong{Kým pri mne spíš}[by={Pavol Habera}]\label{song-211}
\num
...
\beginsong{Kytka}[by={Brontosauři}]\label{song-212}
\num
...
\beginsong{Laciný víno}[by={Jaroslav Samson Lenk}]\label{song-213}
\num
...
\beginsong{Lachtani}[by={Jaromír Nohavica}]\label{song-214}
\chorusi
...
\beginsong{Land Down Under}[by={Men At Work}]\label{song-215}
\num
...
\beginsong{Lásko}[by={Karel Kryl}]\label{song-216}
\num
\chordson
...
\beginsong{Learning To Fly}[by={Tom Petty}]\label{song-217}
...
\beginsong{Leaving on a Jet Plane}[by={John Denver}]\label{song-218}
\num
...
\beginsong{Lenka}[by={Tomáš Klus}]\label{song-219}
\num
...
\beginsong{Let Her Go}[by={Passenger}]\label{song-220}
\capo{7}
\emptyv
\cseq{\[F] \[C] \[G] \[Am] \[F] \[C] \[G]}\\
\cl
...
\beginsong{Let It Be}[by={Beatles}]\label{song-221}
\num
...
\beginsong{Life's for the Living}[by={Passenger}]\label{song-222}
\chordsoff
\num
\chordson
...
\beginsong{Lilie skautská}[by={Taxmeni}]\label{song-223}
\num
...
\beginsong{Linda}[by={Ivan Mládek}]\label{song-224}
\freev
...
\beginsong{Little Lion Man}[by={Mumford and Sons}]\label{song-225}
\capo{5}
...
\beginsong{Loď John B}\label{song-226}
\num
...
\beginsong{Lodníkův lament}[by={Hop trop}]\label{song-227}
\num
...
\beginsong{Louisiana}[by={Hop trop}]\label{song-228}
\num
...
\beginsong{Love Is All Around}[by={Wet Wet Wet}]\label{song-229}
\num
...
\beginsong{Lovec Amorů}[by={Epy de Mye}]\label{song-230}
\capo{2}
\num
...
\beginsong{Made in Valmez}[by={Mňága a Žďorp}]\label{song-231}
...
\beginsong{Malování}[by={Divokej Bill}]\label{song-232}
\intro
...
\beginsong{Mám jizvu na rtu}[by={Jaromír Nohavica}]\label{song-233}
\num
...
\beginsong{Mamutí křik}[by={Nezmaři}]\label{song-234}
\num
...
\beginsong{Margita}[by={Jaromír Nohavica}]\label{song-235}
\num
...
\beginsong{Marie}[by={Tomáš Klus}]\label{song-236}
\emptyv
\cseq{\[C] \[E] \[F] \[G]}
\cl\chordsoff\num
...
\beginsong{Marie}[by={Zuzana Navarová}]\label{song-237}
\num
...
\beginsong{Marsyas a Apollón}[by={Marsyas}]\label{song-238}
\num
\chordson
...
\beginsong{Mařenka}[by={Jaromír Nohavica}]\label{song-239}
\freev
...
\beginsong{Mávátka}[by={Jaromír Nohavica}]\label{song-240}
\num
...
\beginsong{Mercy Me}[by={Alkaline Trio}]\label{song-241}
\emptyv
\cseq{\[C] \[Am] \[F]}\\
\cl
\chordsoff
...
\beginsong{Metro pro krtky}[by={Jaromír Nohavica}]\label{song-242}
\num
...
\beginsong{Mezi horami}[by={Čechomor}]\label{song-243}
\num
...
\beginsong{Mikymauz}[by={Jaromír Nohavica}]\label{song-244}
\pick{PIMAMIAM}
\num
...
\beginsong{Milenci v texaskách}[by={Starci na chmelu}]\label{song-245}
\num
...
\beginsong{Mistr Mississippi}[by={KTO}]\label{song-246}
\num
...
\beginsong{Mladičká básnířka}[by={Jaromír Nohavica}]\label{song-247}
\num
...
\beginsong{Mlýny}[by={Spirituál kvintet}]\label{song-248}
\chor
...
\beginsong{Montér blues}[by={Vlasta Redl}]\label{song-249}
\num
...
\beginsong{Moonlight Shadow}[by={Mike Oldfield}]\label{song-250}
\transpose{7}
\num
...
\beginsong{Morče za volantem}[by={Peshata}]\label{song-251}
\emptyv
\cseq{\[Am] \[C] \[F] \[G]}\\
\cl
\chordsoff
...
\beginsong{Morituri te salutant}[by={Karel Kryl}]\label{song-252}
\num
...
\beginsong{Mravenčí ukolébavka}[by={Svěrák a Uhlíř}]\label{song-253}
\num
...
\beginsong{Muchomůrky bílé}[by={Milan Mejla Hlavsa}]\label{song-254}
\num
...
\beginsong{Můj pes}[by={Jaromír Nohavica}]\label{song-255}
\intro
\cseq{\[G] \[D] \[Em] \[D] \[C] \[D] \[G]}\\
\cl
\chordsoff
...
\beginsong{Mumie}[by={Slávek Janoušek}]\label{song-256}
\averse
...
\beginsong{Muzeum}[by={Jaromír Nohavica}]\label{song-257}
\num
...
\beginsong{Můžem si za to oba}[by={Luboš Pospíšil}]\label{song-258}
\num
...
\beginsong{My Bonnie Lies Over the Ocean}\label{song-259}
\num
...
\beginsong{Myš}[by={Jaroslav Hutka}]\label{song-260}
\num
...
\beginsong{Myš na konci léta}[by={Jaromír Nohavica}]\label{song-261}
\capo{3}
\num
...
\beginsong{Na kameni kámen}[by={Jan Nedvěd}]\label{song-262}
\num
...
\beginsong{Na kolena}[by={Ivan Hlas}]\label{song-263}
\num
...
\beginsong{Na konečnou}[by={Mňága a Žďorp}]\label{song-264}
\capo{3}
\averse
...
\beginsong{Na ptáky jsme krátký}[by={Janek Ledecký}]\label{song-265}
\chor
...
\beginsong{Na sever}[by={Kabát}]\label{song-266}
\num
...
\beginsong{Na stanici polární}[by={Mňága a Žďorp}]\label{song-267}
\capo{3}
\averse
...
\beginsong{Na Španělských schodech}[by={Druhá tráva}]\label{song-268}
\capo{3}
\num
...
\beginsong{Nad stádem koní}[by={Buty}]\label{song-269}
\emptyv
\cseq{\[D] \[A] \[Em] \[G]}
\cl\chordsoff\num
...
\beginsong{Nagasaki Hirošima}[by={Mňága a Žďorp}]\label{song-270}
\num
...
\beginsong{Nahá v dešti}[by={Luboš Odháněl}]\label{song-271}
\num
...
\beginsong{Náchodský zámeček}[by={Lidová}]\label{song-272}
\num
...
\beginsong{Námořnická}[by={Karel Plíhal}]\label{song-273}
\num
...
\beginsong{Nebe}[by={Anna K}]\label{song-274}
%\transpose{2}
% \capo{2}
...
\beginsong{Nebe na zemi}[by={Jiří Voskovec, Jan Werich a Jaroslav Ježek}]\label{song-275}
...
\beginsong{Nebezpečný síly}[by={Neřež}]\label{song-276}
\intro
...
\beginsong{Něco na léto}[by={Žamboši}]\label{song-277}
\num
...
\beginsong{Něco za něco}[by={Nezmaři}]\label{song-278}
\capo{2}
\intro
...
\beginsong{Nedávno}[by={Jarret}]\label{song-279}
\num
...
\beginsong{Něgdy}[by={Mňága a Žďorp}]\label{song-280}
\num
...
\beginsong{Nehrálo se o ceny}[by={Hop trop}]\label{song-281}
\num
...
\beginsong{Nech mě spát}[by={Mňága a Žďorp}]\label{song-282}
\emptyv
\cseq{\[D] \[G] \[F] \[C] \[B]}\\
\cl
\chordsoff
...
\beginsong{Nechte nás}[by={Jaroslav Samson Lenk}]\label{song-283}
\capo{3}
\intro
...
\beginsong{Nejlíp jim bylo}[by={Mňága a Žďorp}]\label{song-284}
\capo{3}
\emptyv
...
\beginsong{Nejvíc se Klára těší na neděli}[by={Mňága a Žďorp}]\label{song-285}
...
\beginsong{Neklid}[by={Tomáš Klus}]\label{song-286}
\emptyv
\cseq{\[C] \[E] \[Am] \[F]}
\cl\chordsoff\num
...
\beginsong{Některé otázky už si prostě nekladu}[by={Mňága a Žďorp}]\label{song-287}
\capo{1}
\averse
...
\beginsong{Nenávratná}[by={Tomáš Klus}]\label{song-288}
\emptyv
\cseq{\[G] \[D] \[C] \[Em] \[D]}\\
\cl
\chordsoff
...
\beginsong{Nevermore}[by={Jaromír Nohavica}]\label{song-289}
\num
...
\beginsong{Nezacházej slunce}[by={Moravská lidová}]\label{song-290}
\num
...
\beginsong{Nikdo to nebere}[by={Bratři Ebenové}]\label{song-291}
\emptyv
\cseq{\[Em\hidx{7}] \[A]}\\
\cl
\chordsoff
...
\beginsong{Nikdy nic nebylo}[by={Sto zvířat}]\label{song-292}
\emptyv
\cseq{\[Am] \[F] \[D] \[G]}
\cl\chordsoff\num
...
\beginsong{Nina}[by={Tomáš Klus}]\label{song-293}
\emptyv
\cseq{\[D] \[Hm] \[G] \[A]}\\
\cl
\chordsoff
...
\beginsong{Nosorožec}[by={Karel Plíhal}]\label{song-294}
\num
...
\beginsong{O malém rytíři}[by={Traband}]\label{song-295}
\chor
...
\beginsong{O znakoplavkách a tak}[by={Žamboši}]\label{song-296}
\num
...
\beginsong{Odpočiň si, Sáro}[by={Druhá tráva}]\label{song-297}
\num
...
\beginsong{Oh Freedom}[by={Spirituál kvintet}]\label{song-298}
\num
...
\beginsong{Okno mé lásky}[by={Olympic}]\label{song-299}
\num
...
\beginsong{Omnia vincit Amor}[by={Klíč}]\label{song-300}
\num
...
\beginsong{One of Us}[by={Joan Osborne}]\label{song-301}
\capo{2}
\emptyv
\cseq{\[Em] \[C] \[G] \[D]}\\
\cl
...
\beginsong{Only You}[by={Flying Pickets}]\label{song-302}
\bridge
...
\beginsong{Ooh La}[by={The Kooks}]\label{song-303}
\emptyv
\cseq{\[Am] \[F] \[Dm]}\\
\cl
\chordsoff
...
\beginsong{Opatrujte vaše děti}\label{song-304}
\emptyv
\cseq{\[Em] \[C] \[Am] \[D]}\\
\cl
\chordsoff
...
\beginsong{Outsider waltz}[by={Wabi Daněk}]\label{song-305}
\num
...
\beginsong{Paměť stromů}[by={Bedřich Ludvík}]\label{song-306}
\num
...
\beginsong{Panenka}[by={Poutníci}]\label{song-307}
\num
...
\beginsong{Panenka}[by={Tomáš Klus}]\label{song-308}
\capo{3}
\num
...
\beginsong{Papírové řetězy}[by={Wabi Daněk}]\label{song-309}
\capo{3}
\num
...
\beginsong{Pár minut}[by={Cop}]\label{song-310}
\chorusi
...
\beginsong{Patient Love}[by={Passenger}]\label{song-311}
\capo{6}
\emptyv
\cseq{\[Am] \[F] \[C] \[G]}\\
\cl
...
\beginsong{Perfect Day}[by={Lou Reed}]\label{song-312}
\num
...
\beginsong{Petěrburg}[by={Jaromír Nohavica}]\label{song-313}
\num
...
\beginsong{Pijte vodu}[by={Jaromír Nohavica}]\label{song-314}
\chor
...
\beginsong{Ping-pong}[by={Wabi Daněk}]\label{song-315}
\num
...
\beginsong{Písek}[by={Nezmaři}]\label{song-316}
\num
...
\beginsong{Píseň lásky}[by={Chemik}]\label{song-317}
\intro
\cseq{\[C] \[G] \[C] \[C] \[G]}\\
\cl
\chordsoff
...
\beginsong{Píseň malých pěšáků}[by={Pavel Lohonka Žalman}]\label{song-318}
\num
...
\beginsong{Píseň pro malou Lenku}[by={Jaromír Nohavica}]\label{song-319}
...
\beginsong{Píseň zhrzeného trampa}[by={Jaromír Nohavica}]\label{song-320}
\num
...
\beginsong{Píseň, co mě učil listopad}[by={Wabi Daněk}]\label{song-321}
\num
...
\beginsong{Pískající cikán}[by={Spirituál Kvintet}]\label{song-322}
\num
...
\beginsong{Písnička pro tebe}[by={Mňága a Žďorp}]\label{song-323}
\num
...
\beginsong{Pocity}[by={Tomáš Klus}]\label{song-324}
\emptyv
\cseq{\[G] \[D] \[Em] \[C]}\\
\cl
\chordsoff
...
\beginsong{Pod dubem}[by={Zdeněk Svěrák a Jaromír Uhlíř}]\label{song-325}
\chor
...
\beginsong{Podvod}[by={Jan Nedvěd}]\label{song-326}
\capo{3}
\num
...
\beginsong{Pohádka}[by={Karel Plíhal}]\label{song-327}
\intro
...
\beginsong{Pohár a kalich}[by={Klíč}]\label{song-328}
\num
...
\beginsong{Pohoda}[by={Kabát}]\label{song-329}
\intro
\cseq{\[D] \[A] \[E] \[Hm]}\\
\cl
\chordsoff
...
\beginsong{Pochod marodů}[by={Jaromír Nohavica}]\label{song-330}
\num
...
\beginsong{Popel žhne}[by={Mňága a Žďorp}]\label{song-331}
\capo{3}
\num
...
\beginsong{Pořád ta samá}[by={Tomáš Klus}]\label{song-332}
\averse
...
\beginsong{Poutník a dívka (Ráchel)}[by={Spirituál Kvintet}]\label{song-333}
\num
...
\beginsong{Pramínek vlasů}[by={Jiří Suchý a Jiří Šlitr}]\label{song-334}
\num
...
\beginsong{Pražce}[by={Pavel Dobeš}]\label{song-335}
\num
...
\beginsong{Proklínám}[by={Janek Ledecký}]\label{song-336}
\num
...
\beginsong{Prolog života}[by={ČP 8}]\label{song-337}
\emptyv
\cseq{\[Em] \[D] \[Em] \[D]}\\
\cl
\chordsoff
...
\beginsong{Proměny}[by={Čechomor}]\label{song-338}
\num
...
\beginsong{Proutníci kluci}[by={Jaromír Nohavica}]\label{song-339}
\num
...
\beginsong{Prší}[by={Karel Plíhal}]\label{song-340}
\chor
...
\beginsong{První signální}[by={Chinaski}]\label{song-341}
\num
...
\beginsong{Předměstí}[by={UDG}]\label{song-342}
\emptyv
\cseq{\[E] \[A]}\\
\cl
\chordsoff
...
\beginsong{Přičichnutí alergikovo}[by={Tomáš Klus}]\label{song-343}
\averse
...
\beginsong{Přítel}[by={Jaromír Nohavica}]\label{song-344}
...
\beginsong{Ptáčata}[by={Brontosauři}]\label{song-345}
\num
...
\beginsong{Raci v práci}[by={Kabát}]\label{song-346}
...
\beginsong{Ráda se miluje}[by={Karel Plíhal}]\label{song-347}
\chor
...
\beginsong{Rakety}[by={Jaromír Nohavica}]\label{song-348}
...
\beginsong{Rána v trávě}[by={Pavel Lohonka Žalman}]\label{song-349}
\chor
...
\beginsong{Ráno bylo stejný}[by={Nezmaři}]\label{song-350}
\num
...
\beginsong{Rocket Man}[by={Elton John}]\label{song-351}
\num
...
\beginsong{Rodné lány}[by={Mňága a Žďorp}]\label{song-352}
\num
\chordsoff
...
\beginsong{Rosa na kolejích}[by={Wabi Daněk}]\label{song-353}
...
\beginsong{Ruby}[by={Pavel Bobek}]\label{song-354}
\num
...
\beginsong{Runaway}[by={The Kooks}]\label{song-355}
\emptyv
\cseq{\[Em] \[Hm] \[D] \[G]}\\
\cl
\chordsoff
...
\beginsong{Runaway Train}[by={Soul Asylum}]\label{song-356}
\emptyv
\cseq{\[C] \[Em] \[Am] \[G]}\\
\cl
\chordsoff
...
\beginsong{Růže z papíru}[by={Nedvědi}]\label{song-357}
\num
...
\beginsong{Růžička}[by={Spirituál kvintet}]\label{song-358}
\num
...
\beginsong{Sametová}[by={Žlutej pes}]\label{song-359}
\num
...
\beginsong{Samurajský meče}[by={Vypsaná fixa}]\label{song-360}
\emptyv
...
\beginsong{Sáro!}[by={Traband}]\label{song-361}
\chorusi
...
\beginsong{Sbohem galánečko}[by={Moravská lidová (Vlasta Redl)}]\label{song-362}
\num
...
\beginsong{Scarborough Fair}[by={Paul Simon a Art Garfunkel}]\label{song-363}
\num
...
\beginsong{Seaside}[by={The Kooks}]\label{song-364}
\capo{1}
\num
...
\beginsong{Sedmnáct dnů}[by={Jiří Wabi Ryvola}]\label{song-365}
\num
...
\beginsong{Sen}[by={Lucie}]\label{song-366}
\num
...
\beginsong{Seňore}[by={Druhá tráva}]\label{song-367}
\num
...
\beginsong{Seventy-Four, Seventy-Five}[by={The Connels}]\label{song-368}
\num
...
\beginsong{Skálo}[by={Svěrák a Uhlíř}]\label{song-369}
\chor
...
\beginsong{Skládanka}[by={Nedvědi}]\label{song-370}
\num
...
\beginsong{Slavíci z Madridu}[by={Waldemar Matuška}]\label{song-371}
\bridge
...
\beginsong{Smuteční marše}[by={Druhá tráva}]\label{song-372}
\num
...
\beginsong{Smutné a lehké}[by={UDG}]\label{song-373}
\emptyv
\cseq{\[Em] \[C] \[G] \[D]}\\
\cl
\chordsoff
...
\beginsong{Snad jsem to zavinil já}[by={Olympic}]\label{song-374}
\num
...
\beginsong{Somebody That I Used to Know}[by={Gotye}]\label{song-375}
\capo{5}
\intro\cseq{\[Am] \[G]}\\\cl
\chordsoff
\averse
...
\beginsong{Sound of Silence}[by={Paul Simon \& Art Garfunkel}]\label{song-376}
\num
...
\beginsong{Sovy v mazutu}[by={František Sahula}]\label{song-377}
\num
...
\beginsong{Spaste svoje duše}[by={Mňága a Žďorp}]\label{song-378}
\num
...
\beginsong{Správná pětka}[by={Zvlášňý škola}]\label{song-379}
\num
...
\beginsong{Stánky}[by={Nedvědi}]\label{song-380}
\num
...
\beginsong{Star of the County Down}[by={Irská lidová (verze Irish Rovers)}]\label{song-381}
\num
...
\beginsong{Stará archa}[by={Spirituál kvintet}]\label{song-382}
\chor
...
\beginsong{Starosta}[by={No Name}]\label{song-383}
\num
...
\beginsong{Starý dům}[by={Listolet}]\label{song-384}
\emptyv
\cseq{\[Em] \[G] \[D] \[Em]}\\
\cl
\num
...
\beginsong{Starý muž}[by={Jaromír Nohavica}]\label{song-385}
\capo{5}
\num
...
\beginsong{Starý příběh}[by={Spirituál kvintet}]\label{song-386}
\num
...
\beginsong{Statistika}[by={Zdeněk Svěrák a Jaromír Uhlíř}]\label{song-387}
\num
...
\beginsong{Stejně jako já}[by={Chinaski}]\label{song-388}
\num
...
\beginsong{Sto kroků samoty}[by={Jarret}]\label{song-389}
\intro
...
\beginsong{Stop Crying Your Heart Out}[by={Oasis}]\label{song-390}
...
\beginsong{Stromy}[by={Wabi Daněk}]\label{song-391}
\num
...
\beginsong{Strýček Jack}[by={Americká lidová, text Jiří Voskovec a Jan Werich}]\label{song-392}
\num
...
\beginsong{Střízlivý maturant}[by={Chemik}]\label{song-393}
...
\beginsong{Studený nohy}[by={Radůza}]\label{song-394}
\num
...
\beginsong{Stýskání}[by={Bratři Ebenové}]\label{song-395}
...
\beginsong{Sunday, Bloody Sunday}[by={U2}]\label{song-396}
\averse
...
\beginsong{Svatební}[by={Jaromír Nohavica}]\label{song-397}
\emptyv
\cseq{\[D] \[A] \[G] \[A]}
\cl\chordsoff\num
...
\beginsong{Sway}[by={The Kooks}]\label{song-398}
\capo{3}
\emptyv
...
\beginsong{Šestý smysl}[by={Anna K.}]\label{song-399}
\emptyv
\cseq{\[D] \[A] \[G]}\\
\cl
\chordsoff
...
\beginsong{Šibenice}[by={Divokej Bill}]\label{song-400}
\num
...
\beginsong{Šípková Růženka}[by={Jiří Schelinger}]\label{song-401}
\num
...
\beginsong{Škoda 1000 MB}[by={Slávek Janoušek}]\label{song-402}
\num
...
\beginsong{Šnečí blues}[by={Jaromír Nohavica}]\label{song-403}
\num
...
\beginsong{Šrouby do hlavy}[by={Lucie}]\label{song-404}
\num
...
\beginsong{Tabáček}[by={Chinaski}]\label{song-405}
\averse
...
\beginsong{Table for One}[by={Passenger}]\label{song-406}
\num
...
\beginsong{Tajný plán}[by={Mňága a Žďorp}]\label{song-407}
\emptyv
...
\beginsong{Tak už mi má holka mává}\label{song-408}
\num
...
\beginsong{Taking Pictures of You}[by={The Kooks}]\label{song-409}
\capo{3}
\emptyv
\cseq{\[G] \[Em] \[Hm]}\\
\cl
...
\beginsong{Tereza}[by={Hoboes}]\label{song-410}
\num
...
\beginsong{Těšínská}[by={Jaromír Nohavica}]\label{song-411}
\num
...
\beginsong{The Biplane Evermore}[by={The Irish Rovers}]\label{song-412}
\intro
\cseq{\[C] \[Am] \[C] \[Am]}\\
\cl
\chordsoff
...
\beginsong{Tichý muž}[by={Traband}]\label{song-413}
...
\beginsong{Times They Are A-Changing}[by={Bob Dylan}]\label{song-414}
\num
...
\beginsong{Tisíc dnů mezi námi}[by={Nerez}]\label{song-415}
\averse
...
\beginsong{To tá Heľpa}[by={Slovenská}]\label{song-416}
\num
...
\beginsong{Tomáš}[by={Kamelot}]\label{song-417}
\num
...
\beginsong{Toulavej}[by={Vojta Tomáško}]\label{song-418}
\num
...
\beginsong{Trubadúrská}[by={Karel Plíhal}]\label{song-419}
\capo{2}
\num
...
\beginsong{Tři čuníci}[by={Jaromír Nohavica}]\label{song-420}
\num
...
\beginsong{Tři kříže}[by={Hop trop}]\label{song-421}
\num
...
\beginsong{Tři sudičky}[by={Jaromír Nohavica}]\label{song-422}
\emptyv
\cseq{\[G] \[D] \[C] \[D] \[G]}\\
\cl
\chordsoff
...
\beginsong{Tulácký ráno}[by={Nedvědi}]\label{song-423}
\num
...
\beginsong{Ukolébavka pro Kubu a Lenku}[by={Jaromír Nohavica}]\label{song-424}
\averse
...
\beginsong{Ukolíbafka}[by={Hm}]\label{song-425}
\num
...
\beginsong{Už to nenapravím}[by={Jaroslav Samson Lenk}]\label{song-426}
\capo{1}
\chordsoff\chor
Vap tada dap\ldots
\cl\chordson\averse
...
\beginsong{V moři je místa dost}[by={Jaromír Nohavica}]\label{song-427}
\chor
...
\beginsong{V myčce}[by={Hm}]\label{song-428}
\intro
...
\beginsong{V pořádku}[by={Nerez}]\label{song-429}
\emptyv
...
\beginsong{Valčík na rozloučenou}[by={Taxmeni}]\label{song-430}
\num
...
\beginsong{Válečná}[by={Tomáš Klus}]\label{song-431}
\emptyv
\cseq{\[Hm] \[A] \[G] \[F\shrp{}]}\\
\cl
\chordsoff
...
\beginsong{Válka růží}[by={Spirituál kvintet}]\label{song-432}
\emptyv
...
\beginsong{Vandrovní}[by={Jaroslav Samson Lenk}]\label{song-433}
\num
...
\beginsong{Variace na renesanční téma}[by={Vladimír Mišík}]\label{song-434}
\emptyv
\cseq{\[Am] \[F] \[G] \[Am]}
\cl\chordsoff\num
...
\beginsong{Včelín}[by={Čechomor}]\label{song-435}
\num
...
\beginsong{Ve 4 ráno}[by={Mňága a Žďorp}]\label{song-436}
\num
...
\beginsong{Ve skříni}[by={Karel Plíhal}]\label{song-437}
% \capo{3}
\num
...
\beginsong{Večerky}[by={Mňága a Žďorp}]\label{song-438}
\num
...
\beginsong{Večerní}[by={Karel Plíhal a Jaromír Nohavica}]\label{song-439}
\num
...
\beginsong{Veď mě dál, cesto má}[by={Pavel Bobek}]\label{song-440}
\num
...
\beginsong{Veličenstvo Kat}[by={Karel Kryl}]\label{song-441}
\num
...
\beginsong{Velká voda}[by={Jaromír Nohavica}]\label{song-442}
\emptyv
\cseq{\[Am] \[C] \[Dm] \[E]}\\
\cl
\chordsoff
...
\beginsong{Velrybářská výprava}[by={Pacifik}]\label{song-443}
\num
...
\beginsong{Venku zuří jaro}[by={Jarret}]\label{song-444}
\num
...
\beginsong{VeSmíru}[by={Tomáš Klus}]\label{song-445}
\num
...
\beginsong{Větříček}[by={Čechomor}]\label{song-446}
\averse
...
\beginsong{Vínečko bílé}[by={Moravská lidová}]\label{song-447}
\num
...
\beginsong{Vizovice}[by={Fleret}]\label{song-448}
\averse
...
\beginsong{Vlakem na Kolín}[by={Neřež}]\label{song-449}
\num
...
\beginsong{Vlaštovko, leť}[by={Jaromír Nohavica}]\label{song-450}
\pick{PIMAMI}
\num
...
\beginsong{Vlaštovky}[by={Traband}]\label{song-451}
\num
...
\beginsong{Voda živá}[by={Aneta Langerová}]\label{song-452}
\intro
\cseq{\[G] \[D] \[G] \[D]}\\
\cl
\chordsoff
...
\beginsong{Vodácká holka}[by={Jaroslav Samson Lenk}]\label{song-453}
\averse
...
\beginsong{Vstávej, holka}[by={Karel Plíhal}]\label{song-454}
\num
...
\beginsong{Výhledově}[by={Mňága a Žďorp}]\label{song-455}
\emptyv
\cseq{\[G] \[C] \[Em] \[D]}\\
\cl
\chordsoff
...
\beginsong{Vyšla luna bílá}[by={Francouzská lidová}] \label{song-456}
\num
...
\beginsong{What Shall We Do With the Drunken Sailor}[by={Irská lidová (verze Irish Rovers)}]\label{song-457}
\num
...
\beginsong{What You're Thinking}[by={Passenger}]\label{song-458}
\capo{3}
\emptyv
\cseq{\[Em] \[C] \[G] \[D]}\\
\cl
...
\beginsong{Wind of Change}[by={Scorpions}]\label{song-459}
\capo{4}
\intro
...
\beginsong{Wish You Were Here}[by={Pink Floyd}]\label{song-460}
\capo{3}
\intro\emptyspace\\ \cl
\chordsoff
\averse
...
\beginsong{Wonderwall}[by={Oasis}]\label{song-461}
\intro
...
\beginsong{Yesterday}[by={Beatles}]\label{song-462}
\num
...
\beginsong{Your Song}[by={Elton John}]\label{song-463}
\capo{3}
\begin{textblock}{1.5}(10.5,0)\noindent 
...
\beginsong{Za svou pravdou stát}[by={Spirituál kvintet}]\label{song-464}
\num
...
\beginsong{Zafúkané}[by={Fleret}]\label{song-465}
...
\beginsong{Zahrada ticha}[by={Pavel Roth}]\label{song-466}
\num
...
\beginsong{Zahrádka}[by={Epy de Mye}]\label{song-467}
\num
...
\beginsong{Zachraňte koně}[by={Kamelot}]\label{song-468}
\intro
...
\beginsong{Zajíci}[by={Jaromír Nohavica}]\label{song-469}
\num
...
\beginsong{Zanedbaný sex}[by={Elán}]\label{song-470}
\emptyv
\cseq{\[C] \[Dm] \[F] \[G]}\\
\cl
\chordsoff
...
\beginsong{Zatanči}[by={Jaromír Nohavica}]\label{song-471}
\emptyv
\cseq{\[Em] \[G] \[D] \[Em]}\\
\cl
\chordsoff
...
\beginsong{Zatímco se koupeš}[by={Jaromír Nohavica}]\label{song-472}
...
\beginsong{Zatracenej život}[by={Greenhorns}]\label{song-473}
\num
...
\beginsong{Zdá sa, že to stačí}[by={Zuzana Smatanová}]\label{song-474}
\intro
\cseq{\[G] \[C] \[G] \[C]}\\
\cl
\chordsoff
...
\beginsong{Zdálo sa ně zdálo}[by={Čechomor}]\label{song-475}
\intro
\cseq{\[Am] \[G] \[D]}
\cl\num
...
\beginsong{Zejtra mám}[by={Ready Kirken}]\label{song-476}
%\capo{3} at g
\num
...
\beginsong{Země antilop}[by={Kamelot}]\label{song-477}
\intro
...
\beginsong{Zítra ráno v pět}[by={Jaromír Nohavica}]\label{song-478}
\num
...
\beginsong{Zmrzlinář}[by={Marsyas}]\label{song-479}
...
\beginsong{Zůstat tam, kde jsem}[by={Slávek Janoušek}]\label{song-480}
\num
...
\beginsong{Zvědavá}[by={UDG}]\label{song-481}
\transpose{-2}
\num
...
\beginsong{Zvěrokruh}[by={Jarret}]\label{song-482}
\num
...
\beginsong{Želva}[by={Olympic}]\label{song-483}
\num
...
\beginsong{Ženy mužů}[by={Epy de Mye}]\label{song-484}
\capo{5}
\num
...
\beginsong{Žily}[by={No Name}]\label{song-485}
\num
...
\beginsong{Život a čas}[by={Mňága a Žďorp}]\label{song-486}
\emptyv
\cseq{\[Em] \[G] \[C] \[D]}\\
\cl
\chordsoff
...
\beginsong{Žízeň}[by={Spirituál kvintet}]\label{song-487}
\num
